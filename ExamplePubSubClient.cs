...
{
  public static async Task<int> PublishOrderedMessagesAsync(string projectId, string topicId, IEnumerable<(string, string, MapField<string, string>)> keysMessagesAndAttributes)
  {
  ...
  public static async Task<int> PullMessagesAsync(string projectId, string subscriptionId, Action<PubsubMessage> messageProcess, int pullForMilliseconds = 5000, bool acknowledge = true)
  {
